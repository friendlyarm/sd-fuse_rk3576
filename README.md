...
*Note: Here we use debian-bullseye-desktop-arm64 system as an example*  
Clone this repository locally, then download and uncompress the [pre-built images](http://112.124.9.243/dvdfiles/rk3576/images-for-eflasher), here you need to download the debian-bullseye-desktop-arm64 and eflasher [pre-built images](http://112.124.9.243/dvdfiles/rk3576/images-for-eflasher):
```
git clone https://github.com/friendlyarm/sd-fuse_rk3576 -b kernel-6.1.y --single-branch sd-fuse_rk3576-kernel6.1
cd sd-fuse_rk3576-kernel6.1
wget http://112.124.9.243/dvdfiles/rk3576/images-for-eflasher/debian-bullseye-desktop-arm64-arm64-images.tgz

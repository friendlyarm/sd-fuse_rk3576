...
if [ -f ../../debian-trixie-core-arm64-images.tgz ]; then
	...
	wget --no-proxy http://${HTTP_SERVER}/dvdfiles/RK3576/images-for-eflasher/debian-trixie-core-arm64-images.tgz
    tar xvzf debian-trixie-core-arm64-images.tgz
fi
...
KERNEL_SRC=$PWD/kernel-rk3576 ./build-kernel.sh debian-trixie-core-arm64
